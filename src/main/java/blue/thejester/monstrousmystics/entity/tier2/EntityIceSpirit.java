...
public class EntityIceSpirit extends EntityJesterMob {
    private static final ResourceLocation LOOT_TABLE = new ResourceLocation(MonstrousMystics.MODID, "entities/ice_spirit");
    private static final String NAME = "ice_spirit";
    ...
    public EntityIceSpirit(World worldIn) {
        super(worldIn);
    ...
    public static void registerSelf(int id) {
        ...
        EntityRegistry.registerModEntity(entity_name, EntityIceSpirit.class, NAME, id,
    ...
    public static void registerOwnRenderer() {
        RenderingRegistry.registerEntityRenderingHandler(EntityIceSpirit.class, RenderIceSpirit.FACTORY);
    }
