...
import blue.thejester.monstrousmystics.client.render.RenderRoaringSpirit;
...
public class EntityRoaringSpirit extends EntityJesterMob {
    private static final ResourceLocation LOOT_TABLE = new ResourceLocation(MonstrousMystics.MODID, "entities/roaring_spirit");
    private static final String NAME = "roaring_spirit";
    private static final int TORNADO_MAX_COOLDOWN = 250;
    ...
    public static final Animation SHOCKWAVE_ANIMATION = Animation.create(30);
    private static final Animation[] ANIMATIONS = {SHOOT_ANIMATION, SHOOT_ANIMATION_LONG, SHOOT_ANIMATION_TORNADO, SHOCKWAVE_ANIMATION};

    public EntityRoaringSpirit(World worldIn) {
        super(worldIn);
    ...
    public static void registerSelf(int id) {
        ...
        EntityRegistry.registerModEntity(entity_name, EntityRoaringSpirit.class, NAME, id,
    ...
    public static void registerOwnRenderer() {
        RenderingRegistry.registerEntityRenderingHandler(EntityRoaringSpirit.class, RenderRoaringSpirit.FACTORY);
    }
    ...
    protected void initEntityAI() {
        ...
        this.tasks.addTask(3, AnimatedSpellAIFactory.closeRepeatingAttackSpell(this, 2, SHOCKWAVE_ANIMATION, 7, Spells.shockwave)); //if we're close enough explode them
